-- =========================================================
-- Seed de portafolio: datos demo para entrevistas y demo publica
-- Ejecutar despues de schema.sql
-- =========================================================
USE tienda_redes;

-- Limpiar datos de demostracion para recargas idempotentes.
...
-- Usuarios demo (hashes de ejemplo, cambiar en produccion).
...
-- Categorias orientadas al nicho de redes.
...
-- Productos demostrativos para catalogo.
...
-- Ordenes demo con detalle para mostrar joins y reportes.
INSERT INTO ordenes (usuario_id, total, estado, direccion_envio, created_at) VALUES
(2, 1410000, 'pagada', 'Calle 80 #15-22, Bogota', NOW() - INTERVAL 5 DAY),
...
-- Carritos demo pendientes de compra.
